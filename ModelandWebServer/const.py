...
METHODS_ALL = ['Kmer', 'RevKmer', 'PseKNC', 'ZCPseKNC',
...
METHODS_DNA = ['Kmer', 'RevKmer', 'PseKNC', 'PseDNC', 'ZCPseKNC',
...
METHODS_DNA_PSE = ['PseDNC', 'PseKNC', 'ZCPseKNC',
                   'PC-PseDNC-General', 'SC-PseDNC-General', 'PC-PseTNC-General', 'SC-PseTNC-General',]

METHODS_RNA = ['Kmer', 'Mismatch', 'Subsequence', 'PC-PseDNC-General', 'SC-PseDNC-General', 'DAC', 'DCC', 'DACC', 'MAC', 'GAC', 'NMBAC', 'Triplet', 'PseSSC', 'PseDPC']
...
METHODS_PROTEIN = ['Kmer', 'PC-PseAAC', 'PC-PseAAC-General', 'SC-PseAAC', 'SC-PseAAC-General', 'AC', 'CC', 'ACC', 'DR', 'DP', 'PDT', 'PDT-Profile', 'Top-n-gram', 'DT', 'AC-PSSM', 'CC-PSSM', 'ACC-PSSM', 'PSSM-DT', 'PSSM-RT', 'SS', 'SASA', 'CS']
METHODS_PROTEIN_KMER = ['Kmer', 'DR', 'DP']
METHODS_PROTEIN_ACC = ['AC', 'CC', 'ACC', 'PDT']
...
METHODS_PSE = ['PseDNC', 'PseKNC', 'ZCPseKNC', 'PC-PseDNC-General', 'PC-PseTNC-General', 'SC-PseDNC-General', 'SC-PseTNC-General',
               'PC-PseAAC-General', 'SC-PseAAC-General', 'PC-PseAAC', 'SC-PseAAC']
METHODS_ACCC = ['DAC', 'DCC', 'DACC', 'TAC', 'TCC', 'TACC', 'MAC', 'GAC', 'NMBAC', 'AC', 'CC', 'ACC', 'PDT']
METHODS_SC = ['Triplet', 'PseSSC', 'PseDPC']
METHODS_NAC = ['Kmer', 'RevKmer', 'IDKmer', 'Mismatch', 'Subsequence', 'DR', 'DP']
METHODS_PROFILE = ['Top-n-gram', 'PDT-Profile', 'DT', 'AC-PSSM', 'CC-PSSM', 'ACC-PSSM', 'PSSM-DT', 'PSSM-RT', 'CS']
METHODS_PS = ['SS', 'SASA']
METHODS_WT = ['PSSM-DT', 'PSSM-RT', 'CS', 'SS', 'SASA']
...
BATCH_PROCESSING_PATH = './data/batch_files/'
